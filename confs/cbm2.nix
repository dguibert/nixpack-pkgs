...
pack._merge (self:
    with self; {
      ...
      #package.hemepure.variants.inlet_boundary = "LADDIOLET";
      #package.hemepure.variants.outlet_boundary = "LADDIOLET";
      #package.hemepure.variants.wall_boundary = "BFL";
      #package.hemepure.variants.wall_inlet_boundary = "LADDIOLETBFL";
      #package.hemepure.variants.wall_outlet_boundary = "LADDIOLETBFL";
      ...
      nimbixImgArgs = self.dockerImgArgs;

      img_pkgs = with final;
      with self.pack.pkgs; let
